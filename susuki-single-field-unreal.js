/**
 * Susuki single field — one dense, fixed field of susuki grass (Unreal / look-dev fork).
 * Same behavior as susuki-single-field.js; imports only *-unreal.js susuki stack.
 */
...
import { buildSusukiCtx } from "./susuki-field-unreal.js";
...
// High LOD: dense, detailed (matches susuki-single-field.js)
...
const STEM_VERTS_HIGH = (STEM_SEGMENTS_HIGH + 1) * 3;
const BAND_VERTS_HIGH = (BAND_SEGMENTS_HIGH + 1) * 2 * 2;
const STEM_VERTS_LOW = (STEM_SEGMENTS_LOW + 1) * 3;
