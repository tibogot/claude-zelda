...
export function createToolState() {
  return {
    ...
    spline: {
      ...
      tunnelColor: "#6c727a",
      guardrailHeight: 0.36,
      guardrailThickness: 0.03,
      guardrailDepth: 0.22,
      guardrailCrownDepth: 0.08,
      guardrailPathSegments: 260,
      guardrailPostSpacing: 2.25,
      guardrailPostWidth: 0.12,
      guardrailPostDepth: 0.1,
      guardrailPostHeight: 0.95,
      guardrailRailYOffset: 0.68,
      guardrailPostSink: 0.08,
