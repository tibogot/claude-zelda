 ...
 */
export function createV2ImageTexGroundMaterial(groundSlot, worldSize, cliffDeps = null, splatOverlay = null, meadowParams = null) {
  const meadowBundle = splatOverlay && meadowParams ? createMeadowTslBundle(meadowParams) : null;
  ...
  mat.colorNode = Fn(() => {
    ...
    if (splatOverlay) {
      ...
      if (meadowBundle) shaded = splatOverlay.blendMeadow(shaded, meadowBundle.meadowProc);
    }
