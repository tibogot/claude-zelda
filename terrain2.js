...
export function createTerrain(scene, PARAMS, options) {
  ...
  const groundColorTex = texLoader.load("textures/pbr_materials/Ground037/Ground037_1K-JPG_Color.jpg");
  ...
  const grassColorTex = texLoader.load("textures/pbr_materials/Grass005/Grass005_1K-JPG_Color.jpg");
